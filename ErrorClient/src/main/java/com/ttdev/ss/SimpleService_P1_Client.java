...
public final class SimpleService_P1_Client {
    ...
    public static void main(String args[]) throws java.lang.Exception {
        ...
        try {
            com.ttdev.ss.ProductQueryResult _query__return = port.query(_query_parameters);
            System.out.println("query.result=" + _query__return);

        } catch (QueryInvalidProductId e) { 
            System.out.println("Expected exception: queryInvalidProductId has occurred.");
