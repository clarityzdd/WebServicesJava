...
public interface SimpleService {
    ...
    @WebMethod(action = "http://ttdev.com/ss/query")
    @SOAPBinding(parameterStyle = SOAPBinding.ParameterStyle.BARE)
    @WebResult(name = "productQueryResult", targetNamespace = "http://ttdev.com/ss", partName = "parameters")
    public ProductQueryResult query(
        @WebParam(partName = "parameters", name = "productQuery", targetNamespace = "http://ttdev.com/ss")
